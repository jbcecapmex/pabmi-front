...
export interface TipoProveedoresInterface {
  uuid: string;
  Cve: string;
  Nombre: string;
  Descripcion: string;
...
export default function TipoProveedores() {
...
const handleClose = ()  => setOpen(false);
  ...
  const handleSave = () => {
    if (cve === "" || nombre === "" || descripcion === ""){
      ...
      axios({
        method  : "post",
        url     : process.env.REACT_APP_APPLICATION_ENDPOINT + "/catalogos/guardatiposproveedores",
        headers : {
        ...
        .then(function (response) {
          ...
          Toast.fire({
            icon  : "success",
            title : "Tipo Proveedor Creado Exitosamente",
          });
          getAllTipoProveedores();
        })
  ...
  const handleDelete = (event: any, cellValues: any) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios({
          method    : "post",
          url       : process.env.REACT_APP_APPLICATION_ENDPOINT +"/catalogos/eliminatiposproveedores",
          headers   : {
                        "Content-Type": "application/json",
                        Authorization: localStorage.getItem("jwtToken") || "",
          },
          ...
          .then(function (response) {
            Toast.fire({
              icon  : "success",
              title : "Tipo Proveedor Eliminado Exitosamente",
            });
            getAllTipoProveedores();
          })
          .catch(function (error) {
...
// Handle update
  const handleUpdate = () => {
    if (cve === "" || nombre === "" || descripcion === ""){
      ...
      axios({
        method  : "post",
        url     : process.env.REACT_APP_APPLICATION_ENDPOINT + "/catalogos/actualizatiposproveedores",
        headers : {
                    "Content-Type": "application/json",
                    Authorization: localStorage.getItem("jwtToken") || "",
        },
        ...
        .then(function (response) {
          ...
          Toast.fire({
            icon  : "success",
            title : "Tipo Proveedor Actualizado Exitosamente",
          });
          getAllTipoProveedores();
        })
        .catch(function (error) {
  ...
  const getAllTipoProveedores = () => {
    axios({
      method    : "get",
      url       : process.env.REACT_APP_APPLICATION_ENDPOINT + "/catalogos/obtienetiposproveedores",
      headers   : {
                    "Content-Type": "application/json",
                    Authorization: localStorage.getItem("jwtToken") || "",
      },
      ...
      .catch(function (error) {
        ...
        }).then((r) => navigate("/Configuracion/Catalogos/TipoProveedores"));
      });
  };
    ...
    >
      ...
      >
        ...
        <Link underline="hover" color="inherit" href="/Inicio">
          ...
          <Link underline="hover" color="inherit" href="/Configuracion/Catalogos/TipoProveedores">
            Configuración
          </Link>
          <Link underline="hover" color="inherit" href="/Configuracion/Catalogos/TipoProveedores">
            Catálogos
          </Link>
          <Typography color="text.primary">Catálogo de Tipo de Proveedor</Typography>
        </Breadcrumbs>
      </Grid>
