...
export default function Municipios() { 
  ...
  return (
    <Grid container sx={{ fontFamily: "MontserratSemiBold" }}>
      ...
      <Typography  variant="h5" sx={{ paddingTop:"1%", paddingLeft:"1%" }}>  Catálogo de Municipios</Typography>  
      <CardContent>
      ...
      {/* Inician los campos del formulario para registrar la nueva Secretaría */}
        ...
        >
          ...
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <Box> 
                <Typography  variant="h5" sx={{ padding:"2%"}}> Catálogo de Municipios</Typography>  
              </Box>
		        </Grid>
