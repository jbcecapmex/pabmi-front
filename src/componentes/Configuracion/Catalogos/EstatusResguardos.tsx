...
export default function EstatusResguardos() {
  ...
  const getAllEstatusResguardos = () => {
    axios({
      ...
      .catch(function (error) {
        ...
        }).then((r) => navigate("/Configuracion/Catalogos/EstatusResguardos"));
      });
  };
    ...
    <Grid container sx={{ }}>
      <Grid sx={{}} item xs={12}>
        ...
        <Link underline="hover" color="inherit" href="/Inicio">
          ...
          <Typography color="text.primary">Catálogo de Estatus de Resguardos</Typography>
        </Breadcrumbs>
      </Grid>
                    ...
                    <Grid item xs={12}>
                      <Box>
                        <Typography variant="h5" sx={{ padding: "1%" }}>
                          Detalle de Estatus de Resguardos
                        </Typography>
                      </Box>
                    </Grid>
