    ...
    <Grid container sx={{ fontFamily: "MontserratSemiBold" }}>
      <Grid item xs={12} paddingLeft={2}>
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="text.primary"> Catálogo de Tipo de Dependencias </Typography>
        </Breadcrumbs>
      </Grid> 
      ...
      <Typography  variant="h5" sx={{ paddingTop:"1%", paddingLeft:"1%" }}>  Catálogo de Tipo de Dependencias </Typography>  
      <CardContent>
      ...
      {/* Inician los campos del formulario para registrar la nueva Secretaría */}
        ...
        >
          ...
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <Box> 
                <Typography  variant="h5" sx={{ padding:"2%"}}> Catálogo de Tipo de Dependencias </Typography>  
              </Box>
		        </Grid>
            ...
            <Box    
              ...
              autoComplete="off"
		          display="flex">
                <TextField
                id="nombreTipoDependencia" 
                label="Nombre del tipo de dependencia"
                size="small"
                variant="outlined" />
                </Box>
            </Grid>
